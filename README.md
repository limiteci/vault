...
# Licence and Legal
- All files availible in this [repository](https://github.com/limiteci/vault) are open source and public domain.
- This [repository](https://github.com/limiteci/vault) relies on the GNU General Public License v3.0 (GPLv3). More information on the license can be found at the [LICENSE](https://github.com/limiteci/vault/blob/main/LICENSE) document
...
=========
* Adding more as I design and find them.
